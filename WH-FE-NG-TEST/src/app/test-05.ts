 ...
 * 
 */
import { ChangeDetectorRef, Component, NgModule, Injectable, Input  } from '@angular/core';
...
export class MainComponent {
    ...
    constructor(private _srv:TestService, private changeDetectorRef: ChangeDetectorRef) {
